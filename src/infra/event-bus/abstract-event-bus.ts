...
export abstract class AbstractEventBus implements EventBusTypes.IEventBusModuleService {
	protected eventToSubscribersMap_: Map<string | symbol, EventBusTypes.SubscriberDescriptor[]> = new Map();

	public get eventToSubscribersMap(): Map<string | symbol, EventBusTypes.SubscriberDescriptor[]> {
  ...
  */
	...
	protected storeSubscribers({
		...
		this.eventToSubscribersMap_.set(event, [...existingSubscribers, newSubscriberDescriptor]);
	}
